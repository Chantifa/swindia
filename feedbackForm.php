...
$name_error = $email_error = $phone_error = $options_error = "";
$name = $email = $phone = $options = $message = $success = "";
...
if($_SERVER["REQUEST_METHOD"]== "POST") {
    ...
    if ($name_error == '' and $email_error == '' and $phone_error == '' and $options_error = '') {
        $message_body = '';
        unset($_POST['submit']);
